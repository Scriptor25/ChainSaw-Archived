...
public class StdFile {
    ...
    public StdFile(StringValue name, StringValue mode) throws IOException {
        this(new File(name.getValue()), mode.getValue());
    }
    ...
    public void out(StringValue fmt, Object... args) throws IOException {
        mWriter.write(String.format(fmt.getValue(), args));
    }
